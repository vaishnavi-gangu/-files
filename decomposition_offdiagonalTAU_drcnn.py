...
for j in range(0,num_of_target_velocity_files):
    ...
    with h5.File('/home/student/Documents/Gangu_project/data/train_off_diagonal_tau/tau_ii'+str(j)+'.h5', 'a') as hf:
...
#for j in range(0,num_of_target_velocity_files):
#    print("creating target data: ",j)
#    with h5.File('/home/student/Documents/Gangu_project/data/test_off_diagonal_tau/tau_ii'+str(j)+'.h5', 'a') as hf:
#        hf.create_dataset('T12', data = T12_target[j])
#        hf.create_dataset('T23', data = T23_target[j])
#        hf.create_dataset('T31', data = T31_target[j])
